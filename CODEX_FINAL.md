...
L3 heaps 1/2/4 → Nim sum 7；L5 heaps 3/4/6 → Nim sum 1；L6–L10 → N/A。Property tests 比較遞迴 mex、solver 勝負與受限直線 Grundy XOR，涵蓋 certified 3×3 盤面、長度 8 水平／垂直線所有子集合、↘ / ↙ 斜線、長度 1–5 的兩線組合及首步後繼；另測到 state API 的 64 格上限、每回合最多 3 顆與三方向手勢限制。
